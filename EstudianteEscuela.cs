...
namespace Tarea3
{
    public class EstudianteEscuela
    {
        ...
        public EstudianteEscuela(string matricula, string nombres, string apellidos, int edad, string direccion, string grado, string seccion, double promedioSemestral,
